...
import { LPProblem, SolverMethod, SolverStep, HistoryItem } from '@/lib/types';
import { LPEngine } from '@/lib/lpEngine';
import { extractLPFromImage, extractLPFromText } from './actions';
import TableauStep from '@/components/TableauStep';
import Graph2D from '@/components/Graph2D';
import ManualBuilder from '@/components/ManualBuilder';
import { Camera, Edit3, Keyboard, Play, CheckCircle, RotateCcw, Moon, Sun, History, Save, Download, Printer, Trash2, Cpu, FileJson, Loader2, RefreshCw, ArrowDown, BarChart2 } from 'lucide-react';
